...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // X TODO (2) Modify the setupSharedPreferences method and onSharedPreferencesChanged method to
    ...
    private void setupSharedPreferences() {
       ...
       // mVisualizerView.setMinSizeScale(1);
        loadShapeSizePreferences(sharedPreferences);
    ...
    private void loadShapeSizePreferences (SharedPreferences sharedPreferences){
        String key = getString(R.string.pref_size_key);
        String defaultSize =  getString(R.string.pref_size_default);
        String sh  = sharedPreferences.getString(key,defaultSize);
        float minSizeScale = Float.parseFloat(sh);
