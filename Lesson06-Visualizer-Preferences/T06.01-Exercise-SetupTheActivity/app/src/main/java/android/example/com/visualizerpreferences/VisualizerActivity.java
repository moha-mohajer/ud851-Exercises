...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // X TODO (1) Create a new Empty Activity named SettingsActivity; make sure to generate the
    // activity_settings.xml layout file as well and add the activity to the manifest

    // XzTODO (2) Add a new resource folder called menu and create visualizer_menu.xml
    // X TODO (3) In visualizer_menu.xml create a menu item with a single item. The id should be
    ...
    // X TODO (5) Add the menu to the menu bar
    ...
    // X TODO (6) When the "Settings" menu item is pressed, open SettingsActivity

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        int itemThatWasSellected = item.getItemId();

        if (itemThatWasSellected == R.id.action_setting){
            Intent destinationActivity = new Intent(this, SettingsActivity.class);
