...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // X TODO (4) Update setupSharedPreferences and onSharedPreferenceChanged to load the color
    ...
    private void setupSharedPreferences() {
        ...
        loadColorFromPerferences(sharedPreferences);
        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    private void loadColorFromPerferences (SharedPreferences sharedPreferences){
        mVisualizerView.setColor(sharedPreferences
                .getString(getString(R.string.pref_color_list_key)
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if(key.equals(getString(R.string.pref_color_list_key))){
            loadColorFromPerferences(sharedPreferences);
        }
    }
