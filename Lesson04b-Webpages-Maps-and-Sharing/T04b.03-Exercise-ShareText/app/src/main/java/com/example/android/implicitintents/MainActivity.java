...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // X TODO (5) Specify a String you'd like to share
        String textToShare = "this is test";
    ...
    // X TODO (1) Create a void method called shareText that accepts a String as a parameter
    private void shareText(String textToShare) {
        // Do steps 2 - 4 within the shareText method

        // X TODO (2) Create a String variable called mimeType and set it to "text/plain"
        String mimeType = "text/plain";

        // X TODO (3) Create a title for the chooser window that will pop up
        String title = "Learning How to Share";

        // X TODO (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
