...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        // X TODO (5) Store an address in a String
        String addressString = "1600 Amphitheatre Parkway, CA";

        // X TODO (6) Use Uri.Builder with the appropriate scheme and query to form the Uri for the address
        ...
        // X TODO (7) Replace the Toast with a call to showMap, passing in the Uri from the previous step
        showMap(address);
    }
    ...
    // X TODO (1) Create a method called showMap with a Uri as the single parameter
    private void showMap(Uri addressUri) {

        // Do steps 2 - 4 within the showMap method
        // X TODO (2) Create an Intent with action type, Intent.ACTION_VIEW
        Intent intent = new Intent(Intent.ACTION_VIEW);

        // X TODO (3) Set the data of the Intent to the Uri passed into this method
        ...
        else Toast.makeText(this, "No Map App installed Or ...", Toast.LENGTH_SHORT).show();
    }
}