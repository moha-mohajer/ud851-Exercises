...
public class MainActivity extends AppCompatActivity implements
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            // X TODO (1) Create a String member variable called mGithubJson that will store the raw JSON
            String mGithubJson;
            ...
            protected void onStartLoading() {
                ...
                // X TODO (2) If mGithubJson is not null, deliver that result. Otherwise, force a load
                if(mGithubJson != null) {
            ...
            // X TODO (3) Override deliverResult and store the data in mGithubJson

            @Override
            public void deliverResult(String data) {
                mGithubJson = data;

                // X TODO (4) Call super.deliverResult after storing the data
