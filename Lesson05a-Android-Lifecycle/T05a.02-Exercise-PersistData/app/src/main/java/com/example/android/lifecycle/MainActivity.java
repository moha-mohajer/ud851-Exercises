...
public class MainActivity extends AppCompatActivity {
    ...
    // X TODO (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // X TODO (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
        if(savedInstanceState != null){
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
                String allPreviousLifecycleCallback = savedInstanceState
                        .getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(allPreviousLifecycleCallback);
            }
        }
    ...
    // X TODO (2) Override onSaveInstanceState

    @Override
    public void onSaveInstanceState(Bundle outState) {

        // Do steps 3 - 5 within onSaveInstanceState
        // X TODO (3) Call super.onSaveInstanceState
        super.onSaveInstanceState(outState);

        // X TODO (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
        logAndAppend(ON_SAVE_INSTANCE_STATE);

        // X TODO (5) Put the text from the TextView in the outState bundle
        String lifecycleDisplayText = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, lifecycleDisplayText);
    }
